...
//        .attr('data-spell-index', 0) // TODO: migrate
//        .hover(Utility.summonerSpellMouseIn, Utility.hideTooltip); // TODO: migrate
//
//    var $summonerSpell2Img = $('<img class="summoner-spell" src="' + DDRAGON_IMG_URL + 'spell/' + summonerSpellsArray[1].image.full + '">')
//        .attr('data-spell-index', 1) // TODO: migrate
//        .hover(Utility.summonerSpellMouseIn, Utility.hideTooltip); // TODO: migrate
//
//    var $passiveImg = $('<img class="passive" src="' + DDRAGON_IMG_URL + 'passive/' + passive.image.full + '">')
//        .hover(Utility.passiveMouseIn, Utility.hideTooltip); // TODO: migrate
...
//                .hover(Utility.spellMouseIn, Utility.hideTooltip) // TODO: migrate
//        );
//    }
//
//    return $div;
